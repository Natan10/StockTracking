        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Solicitations_Employees_RequesterId",
                        column: x => x.RequesterId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Solicitations_Employees_ReviewerId",
            ...
            migrationBuilder.CreateTable(
                name: "StockItemEquipments",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Onu = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockItemEquipments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockItemEquipments_Stocks_StockId",
                        column: x => x.StockId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockItemMaterials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockItemMaterials_Stocks_StockId",
                        column: x => x.StockId,
                        principalTable: "Stocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SolicitationItems_StockItemEquipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "StockItemEquipments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SolicitationItems_StockItemMaterials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "StockItemMaterials",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SolicitationItems_EquipmentId",
                table: "SolicitationItems",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_SolicitationItems_MaterialId",
                table: "SolicitationItems",
                column: "MaterialId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Solicitations_RequesterId",
                table: "Solicitations",
                column: "RequesterId");

            migrationBuilder.CreateIndex(
                name: "IX_Solicitations_ReviewerId",
                table: "Solicitations",
                column: "ReviewerId");

            migrationBuilder.CreateIndex(
                name: "IX_StockItemEquipments_StockId",
                table: "StockItemEquipments",
                column: "StockId");

            migrationBuilder.CreateIndex(
                name: "IX_StockItemMaterials_StockId",
                table: "StockItemMaterials",
                column: "StockId");
        }
